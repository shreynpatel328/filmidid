 ...
 include ( "includes/data.php");	
					 $connect=mysql_connect($host,$us,$ps);
						...
						{	
							...
							if (!(isset($pagenum))) 
							$pagenum = 1; 
							$data = mysql_query("SELECT * FROM video_details") or die(mysql_error()); 
							...
							elseif ($pagenum > $last) 
							 $pagenum = $last; 
								...
								$data_p = mysql_query("SELECT * FROM video_details order by Rating$append desc $max") or die(mysql_error());

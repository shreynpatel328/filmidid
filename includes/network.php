 ...
 include ( "includes/data.php");	
					 $connect=mysql_connect($host,$us,$ps);
						...
						{	
							$db='filmidid';
							mysql_select_db($db);
							$query2="select id from user_login where eMail='$eMail'";
							...
							if (!(isset($pagenum))) 
							$pagenum = 1; 
							$query1="SELECT * FROM network_map where ser_id='$id4login'";
...
echo " <a href='{$_SERVER['PHP_SELF']}?pagenum=$last' style='color:#00ff99'>Last ->></a> ";
		...
		?>
     	<div class="video_container">
			...
			<table border="0">
			<tr>
			<td><?php if($rows>0){ $rows--; ?> <div class="profile_container"><?php $thisid=mysql_result($result1,$k,"cli_id"); $query="select name from user_details d, user_login l where d.eMail=l.eMail and d.password=l.password and l.id='$thisid'"; $result12=mysql_query($query); $thisname=mysql_result($result12,0,"name"); $k++; ?><a href="user.php?id=<?php echo $thisid;?>" style="color:#00FF00"><img src="pics/<?php echo $thisid;?>.png" width="160" height="250"><p style="color:#00FF00" align="center"><?php echo $thisname;?></p></a></div> <?php }?></td> 
